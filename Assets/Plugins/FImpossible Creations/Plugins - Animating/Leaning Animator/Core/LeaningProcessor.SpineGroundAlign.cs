...
namespace FIMSpace
{
    ...
    {
        [Tooltip("Control how much effect of spine ground align you want to apply")] [FPD_Suffix(0f, 1.5f, FPD_SuffixAttribute.SuffixMode.PercentageUnclamped)] public float SpineGroundAlign = 0f;
